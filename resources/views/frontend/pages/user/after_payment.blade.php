...
<a href="/" style="color: #fff; text-decoration: none; position: absolute; padding:10px 15px; background: black;">Back Home</a>
                ...
                <div class="sn-row">
                    <div class="sn-col">
                        ...
                        <div class="sn-row">
                            ...
                            <div class="sn-col">Rs. {{ $booking->busnameforpasger ? ($booking->busnameforpasger->after_discount * $count) : 0 }} </div>
                        </div>
                        <div class="sn-row">
