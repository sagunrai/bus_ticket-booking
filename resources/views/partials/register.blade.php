            ...
            <div class="modal-body">
                <form method="POST" id="registerForm">
                    ...
                    <div class="form-group row">
                        <label for="nameInput" class="col-md-4 col-form-label text-md-right">{{ __('Full Name') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="nameInput" class="col-md-4 col-form-label text-md-right">{{ __('Mobile Number') }}</label>

                        <div class="col-md-6">
                            <input id="nameInput" type="number" class="form-control" name="phone" value="{{ old('phone') }}"  autocomplete="phone" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="nameInput" class="col-md-4 col-form-label text-md-right">{{ __('Gender') }}</label>

                        <div class="col-md-6">
                            <select id="nameInput" type="text" class="form-control" name="gender" value="{{ old('gender') }}"  autocomplete="gender" autofocus>
